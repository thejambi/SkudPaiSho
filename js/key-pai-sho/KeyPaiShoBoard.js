...
KeyPaiSho.Board.prototype.brandNew = function () {
	...
	cells[2] = this.newRow(11, 
		[KeyPaiSho.BoardPoint.neutral(),
		KeyPaiSho.BoardPoint.neutral(),
		KeyPaiSho.BoardPoint.neutral(),
		KeyPaiSho.BoardPoint.neutral(),
		KeyPaiSho.BoardPoint.neutral(),
		KeyPaiSho.BoardPoint.redWhiteNeutral(),
		KeyPaiSho.BoardPoint.neutral(),
		KeyPaiSho.BoardPoint.neutral(),
		KeyPaiSho.BoardPoint.neutral(),
		KeyPaiSho.BoardPoint.neutral(), 
