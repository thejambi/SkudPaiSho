...
GiniGameManager.prototype.doBoardSetup = function() {
	...
	this.board.placeTile(this.tileManager.grabTile(HOST, GiniTileCodes.Koi), new NotationPoint("7,-1"));
	this.board.placeTile(this.tileManager.grabTile(HOST, GiniTileCodes.Dragon), new NotationPoint("7,1"));
	this.board.placeTile(this.tileManager.grabTile(HOST, GiniTileCodes.Badgermole), new NotationPoint("6,-2"));
	this.board.placeTile(this.tileManager.grabTile(HOST, GiniTileCodes.Bison), new NotationPoint("6,2"));
	this.board.placeTile(this.tileManager.grabTile(HOST, GiniTileCodes.Ginseng), new NotationPoint("5,-1"));
	...
	this.board.placeTile(this.tileManager.grabTile(GUEST, GiniTileCodes.Koi), new NotationPoint("-7,1"));
	this.board.placeTile(this.tileManager.grabTile(GUEST, GiniTileCodes.Dragon), new NotationPoint("-7,-1"));
	this.board.placeTile(this.tileManager.grabTile(GUEST, GiniTileCodes.Badgermole), new NotationPoint("-6,2"));
	this.board.placeTile(this.tileManager.grabTile(GUEST, GiniTileCodes.Bison), new NotationPoint("-6,-2"));
	this.board.placeTile(this.tileManager.grabTile(GUEST, GiniTileCodes.Ginseng), new NotationPoint("-5,1"));
};
