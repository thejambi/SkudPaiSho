...
CaptureActuator.prototype.setAnimationOn = function(isOn) {
	this.animationOn = isOn;
};

CaptureActuator.prototype.actuate = function(board, tileManager, markingManager, moveToAnimate) {
	var self = this;
...
CaptureActuator.prototype.htmlify = function(board, tileManager, markingManager, moveToAnimate) {
...
CaptureActuator.prototype.addBoardPoint = function(boardPoint, moveToAnimate) {
	var self = this;
...
CaptureActuator.prototype.doAnimateBoardPoint = function(boardPoint, moveToAnimate, theImg, theDiv) {
