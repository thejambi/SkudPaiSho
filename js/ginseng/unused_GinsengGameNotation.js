...
// Ginseng.NotationMove = function(text) {
// 	this.fullMoveText = text;
// 	this.analyzeMove();
// }

// Ginseng.NotationMove.prototype.analyzeMove = function() {
// 	this.valid = true;
...
// Ginseng.NotationMove.prototype.isValidNotation = function() {
// 	return this.valid;
// };

// Ginseng.NotationMove.prototype.equals = function(otherMove) {
...
// Ginseng.NotationBuilder = function() {
...
// Ginseng.NotationBuilder.prototype.getNotationMove = function(moveNum, player) {
...
// 	return new Ginseng.NotationMove(notationLine);
// };
...
// Ginseng.GameNotation = function() {
// 	this.notationText = "";
// 	this.moves = [];
// }

// Ginseng.GameNotation.prototype.setNotationText = function(text) {
// 	this.notationText = text;
// 	this.loadMoves();
// };

// Ginseng.GameNotation.prototype.addNotationLine = function(text) {
// 	this.notationText += ";" + text.trim();
// 	this.loadMoves();
// };

// Ginseng.GameNotation.prototype.addMove = function(move) {
...
// Ginseng.GameNotation.prototype.removeLastMove = function() {
// 	this.notationText = this.notationText.substring(0, this.notationText.lastIndexOf(";"));
// 	this.loadMoves();
// };

// Ginseng.GameNotation.prototype.getPlayerMoveNum = function() {
// 	var moveNum = 0;
...
// Ginseng.GameNotation.prototype.getNotationMoveFromBuilder = function(builder) {
// 	var moveNum = 0;
// 	var player = HOST;
...
// Ginseng.GameNotation.prototype.loadMoves = function() {
// 	this.moves = [];
// 	var lines = [];
// 	if (this.notationText) {
...
// 		var move = new Ginseng.NotationMove(line);
...
// Ginseng.GameNotation.prototype.getNotationHtml = function() {
// 	var lines = [];
// 	if (this.notationText) {
// 		if (this.notationText.includes(';')) {
// 			lines = this.notationText.split(";");
...
// Ginseng.GameNotation.prototype.notationTextForUrl = function() {
// 	var str = this.notationText;
// 	return str;
// };

// Ginseng.GameNotation.prototype.getNotationForEmail = function() {
// 	var lines = [];
// 	if (this.notationText) {
// 		if (this.notationText.includes(';')) {
// 			lines = this.notationText.split(";");
...
// Ginseng.GameNotation.prototype.getLastMoveText = function() {
// 	return this.moves[this.moves.length - 1].fullMoveText;
// };

// Ginseng.GameNotation.prototype.getLastMoveNumber = function() {
// 	return this.moves[this.moves.length - 1].moveNum;
// };

// Ginseng.GameNotation.prototype.lastMoveHasDrawOffer = function() {
