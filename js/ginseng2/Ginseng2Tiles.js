...
Ginseng2.TilePileNames = {
	banish: "banish"
};

Ginseng2.GinsengTiles = {};
Ginseng2.TileInfo = {};

Ginseng2.TileInfo.initializeTrifleData = function() {
	Ginseng2.TileInfo.setTileNames();

	Trifle.TileInfo.initializeTrifleData();

	Ginseng2.TileInfo.defineGinsengTiles();
};

Ginseng2.TileInfo.setTileNames = function() {
	/* Set tile names that do not match thier keys in TileCodes */
	var tileNames = {};

	tileNames[Ginseng2.TileCodes.WhiteLotus] = "White Lotus";
	tileNames[Ginseng2.TileCodes.Bison] = "Flying Bison";
	tileNames[Ginseng2.TileCodes.LionTurtle] = "Lion Turtle";

	PaiShoGames.currentTileNames = tileNames;
};

Ginseng2.TileInfo.defineGinsengTiles = function() {
	var GinsengTiles = {};

	GinsengTiles[Ginseng2.TileCodes.WhiteLotus] = {
		available: true,
		types: [Ginseng2.TileCodes.WhiteLotus],
		movements: [
			{
				...
				restrictions: [
					{
						...
						targetTileCode: Ginseng2.TileCodes.WhiteLotus,
				...
				triggers: [
					{
						...
						targetTileCodes: [Ginseng2.TileCodes.Ginseng]
					}
				],
	...
	GinsengTiles[Ginseng2.TileCodes.Koi] = {
		available: true,
		types: [Ginseng2.TileType.originalBender],
		movements: [
			{
		...
		abilities: [
			...
			},
			{
				...
				cancelAbilitiesFromTileCodes: [Ginseng2.TileCodes.Bison]
			}
		],
		textLines: [
	...
	GinsengTiles[Ginseng2.TileCodes.Dragon] = {
		available: true,
		types: [Ginseng2.TileType.originalBender],
		movements: [
			{
	...
	GinsengTiles[Ginseng2.TileCodes.Badgermole] = {
		available: true,
		types: [Ginseng2.TileType.originalBender],
		movements: [
			{
	...
	GinsengTiles[Ginseng2.TileCodes.Bison] = {
		available: true,
		types: [Ginseng2.TileType.originalBender],
		movements: [
			{
	...
	GinsengTiles[Ginseng2.TileCodes.LionTurtle] = {
		available: true,
		types: [Ginseng2.TileCodes.LionTurtle],
		movements: [
			{
				type: Trifle.MovementType.standard,
				distance: 5,
				captureTypes: [
					{
						...
						excludedTileCodes: [Ginseng2.TileCodes.LionTurtle]
					}
				],
			}
		],
				...
				triggers: [
					{
						...
						targetTeams: [Trifle.TileTeam.enemy],
						targetTileTypes: [Ginseng2.TileType.originalBender],
	...
	GinsengTiles[Ginseng2.TileCodes.Wheel] = {
		available: true,
	...
	GinsengTiles[Ginseng2.TileCodes.Ginseng] = {
		available: true,
	...
	GinsengTiles[Ginseng2.TileCodes.Orchid] = {
		available: true,
		types: [Trifle.TileType.flower],
		movements: [
			{
				...
				captureTypes: [
					{
						type: Trifle.CaptureType.allExcludingCertainTiles,
						excludedTileCodes: [Ginseng2.TileCodes.WhiteLotus]
					}
				]
			}
		],
		abilities: [
			{
				...
				destinationPile: Ginseng2.TilePileNames.banish,
				triggers: [
					{
	...
	Ginseng2.applyCaptureAndAbilityActivationRequirementRules(GinsengTiles);

	/* if (gameOptionEnabled(CAPTURE_ABILITY_TARGET_1)) {
		debug("Change Lion Turtle and Dragon abilities");
		GinsengTiles[Ginseng2.TileCodes.Dragon].abilities = [
			{
				type: Trifle.AbilityName.captureTargetTiles,
				triggers: [
					{
	...
	Ginseng2.GinsengTiles = GinsengTiles;
};

Ginseng2.applyCaptureAndAbilityActivationRequirementRules = function(GinsengTiles) {
	Object.keys(GinsengTiles).forEach(function(key, index) {
		...
		if (tileInfo.movements && tileInfo.movements.length) {
			tileInfo.movements.forEach(function(movementInfo) {
				...
				if (movementInfo.captureTypes && movementInfo.captureTypes.length) {
					movementInfo.captureTypes.forEach(function(captureTypeInfo) {
						var activationRequirement = {
							...
							targetTileCodes: [Ginseng2.TileCodes.WhiteLotus],
							targetTeams: [Trifle.TileTeam.friendly, Trifle.TileTeam.enemy]
						};
				 ...
				 */
				if (!tileInfo.types.includes(Ginseng2.TileCodes.WhiteLotus)) {
