...
VagabondController.prototype.getDefaultHelpMessageText = function() {
	return "<h4>Vagabond Pai Sho</h4> <p> <p>Vagabond Pai Sho is the Pai Sho variant seen in the fanfiction story <a href='https://www.fanfiction.net/s/7849861/1/Gambler-and-Vagabond' target='_blank'>Gambler and Vagabond</a>.</p> <p><strong>You win</strong> if you capture your opponent's White Lotus tile.</p> <p><strong>On a turn</strong>, you may either deploy a tile or move a tile.</p> <p><strong>You can't capture Flower tiles</strong> until your White Lotus has been deployed.<br /> <strong>You can't capture Non-Flower tiles</strong> until both players' White Lotus tiles have been deployed.</p> <p><strong>Hover</strong> over any tile to see how it works.</p> </p> <p>Select tiles to learn more or <a href='https://skudpaisho.wordpress.com/vagabond-pai-sho/' target='_blank'>view the rules</a>.</p>";
};
