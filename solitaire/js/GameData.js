...
var includeAccentTiles = true; // For Solitaire: Include Accent Tiles or not
var doubleTiles = false; // For Solitaire: Double the amount of tiles (as if playing with both players' tiles)
